...
protected:
    ...
    {
        parcer = new Parcer;
        addCmd.processCommand(parcer->parce("ADD, , , ,17000000,홍 길동,CL2,010-1111-2222,19900302,ADV"));
        addCmd.processCommand(parcer->parce("ADD, , , ,17000001,홍 길훈,CL3,010-1111-2233,19900302,PRO"));
        addCmd.processCommand(parcer->parce("ADD, , , ,17000002,홍 길순,CL2,010-1111-2244,19900306,ADV"));
    }
    virtual void TearDown() override
    {
        delCmd.processCommand(parcer->parce("DEL, , , ,employeeNum,17000000"));
        delCmd.processCommand(parcer->parce("DEL, , , ,employeeNum,17000001"));
        delCmd.processCommand(parcer->parce("DEL, , , ,employeeNum,17000002"));
        delete parcer;
    }
