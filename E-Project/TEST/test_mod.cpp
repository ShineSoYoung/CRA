...
protected:
    ...
    {
        parcer = new Parcer;
        addCmd.processCommand(parcer->parce("ADD, , , ,18050301,KYUMOK KIM,CL2,010-9777-6055,19980906,PRO"));
        addCmd.processCommand(parcer->parce("ADD, , , ,18050302,SEUNGWOO HYUN,CL3,010-1111-2233,19900302,PRO"));
        addCmd.processCommand(parcer->parce("ADD, , , ,19000000,SAM CHOI,CL1,010-3333-1111,19990506,PRO"));
        addCmd.processCommand(parcer->parce("ADD, , , ,18011111,CHOI HYBUSUN,CL4,010-5555-1111,19990508,PRO"));
        addCmd.processCommand(parcer->parce("ADD, , , ,18022222,TAXI CHOI,CL3,010-6666-1111,19990408,PRO"));
        addCmd.processCommand(parcer->parce("ADD, , , ,18000000,HARBANG KIM,CL2,010-3333-1111,19990208,PRO"));
    }

    virtual void TearDown() override
    {
        delCmd.processCommand(parcer->parce("DEL, , , ,employeeNum,18050301"));
        delCmd.processCommand(parcer->parce("DEL, , , ,employeeNum,18050302"));
        delCmd.processCommand(parcer->parce("DEL, , , ,employeeNum,19000000"));
        delCmd.processCommand(parcer->parce("DEL, , , ,employeeNum,18011111"));
        delCmd.processCommand(parcer->parce("DEL, , , ,employeeNum,18022222"));
        delCmd.processCommand(parcer->parce("DEL, , , ,employeeNum,18000000"));
        delete parcer;
    }
...
protected:
    virtual void SetUp() override
    {
        ...
        addCmd.processCommand(parcer->parce("ADD, , , ,18022222,TAXI CHOI,CL3,010-6666-1111,19990408,PRO"));
        addCmd.processCommand(parcer->parce("ADD, , , ,18000000,HARBANG KIM,CL2,010-3333-1111,19990208,PRO"));
        addCmd.processCommand(parcer->parce("ADD, , , ,69010101,HARBANG HYUN,CL2,010-1234-2233,19990208,PRO"));
    }
    ...
    virtual void TearDown() override
    {
        ...
        delCmd.processCommand(parcer->parce("DEL, , , ,employeeNum,18022222"));
        delCmd.processCommand(parcer->parce("DEL, , , ,employeeNum,18000000"));
        delCmd.processCommand(parcer->parce("DEL, , , ,employeeNum,69010101"));
        delete parcer;
